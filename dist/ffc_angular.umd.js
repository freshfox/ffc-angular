(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/platform-browser'), require('ladda'), require('@angular/material'), require('@angular/forms'), require('jquery'), require('chosen-js'), require('@angular/animations'), require('rxjs/ReplaySubject'), require('pikaday'), require('moment')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/platform-browser', 'ladda', '@angular/material', '@angular/forms', 'jquery', 'chosen-js', '@angular/animations', 'rxjs/ReplaySubject', 'pikaday', 'moment'], factory) :
	(factory((global.ffc_angular = global.ffc_angular || {}),global._angular_core,global._angular_platformBrowser,global.Ladda,global._angular_material,global._angular_forms,global.$,null,global._angular_animations,global.rxjs_ReplaySubject,global.Pikaday,global.moment));
}(this, (function (exports,_angular_core,_angular_platformBrowser,Ladda,_angular_material,_angular_forms,$,chosenJs,_angular_animations,rxjs_ReplaySubject,Pikaday,moment) { 'use strict';

$ = 'default' in $ ? $['default'] : $;
Pikaday = 'default' in Pikaday ? Pikaday['default'] : Pikaday;
...
ButtonComponent.propDecorators = {
    ...
    'class': [{ type: _angular_core.Input },],
...
FFMaterialModule.decorators = [
    { type: _angular_core.NgModule, args: [{
                ...
                declarations: [
                    _angular_material.MdProgressSpinner,
                ],
                exports: [
                    _angular_material.MdProgressSpinner
                ],
...
ConfirmComponent.propDecorators = {
    ...
    'onConfirm': [{ type: _angular_core.Output },],
};
...
var FF_INPUT_CONTROL_VALUE_ACCESSOR = {
    ...
    useExisting: _angular_core.forwardRef(function () { return InputComponent; }),
    multi: true
};
...
InputComponent.propDecorators = {
    ...
    'alwaysShowDecimals': [{ type: _angular_core.Input },],
    'numberOfDecimals': [{ type: _angular_core.Input },],
...
SelectComponent.propDecorators = {
    ...
    'valueKey': [{ type: _angular_core.Input },],
    'nameKey': [{ type: _angular_core.Input },],
    'class': [{ type: _angular_core.Input },],
    'disabled': [{ type: _angular_core.Input },],
    'selectedValue': [{ type: _angular_core.Input },],
    'selectedValueChange': [{ type: _angular_core.Output },],
    'label': [{ type: _angular_core.Input },],
    'enableSearchField': [{ type: _angular_core.Input },],
};
...
var ModalService = (function () {
    ...
    ModalService.prototype.createFromFactory = function (componentFactory, options) {
        ...
        var /** @type {?} */ componentRef$ = new rxjs_ReplaySubject.ReplaySubject();
        var /** @type {?} */ childInjector = _angular_core.ReflectiveInjector.resolveAndCreate([], this.injector);
...
ModalPlaceholderComponent.decorators = [
    { type: _angular_core.Component, args: [{
                ...
                animations: [
                    _angular_animations.trigger('modalOuter', [
                        _angular_animations.state('shown', _angular_animations.style({ display: 'flex' })),
                        _angular_animations.state('hidden', _angular_animations.style({ display: 'none' })),
                        _angular_animations.transition('hidden <=> shown', [
                            _angular_animations.animate('0.2s ease')
                        ])
                    ]),
                    _angular_animations.trigger('modal', [
                        _angular_animations.state('shown', _angular_animations.style({ transform: 'scale3d(1, 1, 1)', opacity: 1, display: 'block' })),
                        _angular_animations.state('hidden', _angular_animations.style({ transform: 'scale3d(0.7, 0.7, 0.7)', opacity: 0 })),
                        _angular_animations.transition('hidden <=> shown', [
                            _angular_animations.animate('0.2s ease')
                        ])
                    ]),
                    _angular_animations.trigger('backdrop', [
                        _angular_animations.state('shown', _angular_animations.style({ opacity: 1, display: 'block' })),
                        _angular_animations.state('hidden', _angular_animations.style({ opacity: 0, display: 'none' })),
                        _angular_animations.transition('hidden <=> shown', [
                            _angular_animations.animate('0.2s ease')
                        ])
                    ]),
                    _angular_animations.trigger('closeButton', [
                        _angular_animations.state('shown', _angular_animations.style({ opacity: 1, display: 'block' })),
                        _angular_animations.state('hidden', _angular_animations.style({ opacity: 0, display: 'none' })),
                        _angular_animations.transition('hidden <=> shown', [
                            _angular_animations.animate('0.1s ease')
                        ])
                    ])
                ],
...
ModalPlaceholderComponent.propDecorators = {
    'viewContainerRef': [{ type: _angular_core.ViewChild, args: ["modalplaceholder", { read: _angular_core.ViewContainerRef },] },],
};
var ModalSize = {};
...
var DATEPICKER_VALUE_ACCESSOR = {
    provide: _angular_forms.NG_VALUE_ACCESSOR,
    useExisting: _angular_core.forwardRef(function () { return DatePickerDirective; }),
    multi: true
};
...
FFCoreModule.decorators = [
    { type: _angular_core.NgModule, args: [{
                imports: [_angular_platformBrowser.BrowserModule, FFMaterialModule],
                declarations: [
                    IconComponent,
                    ButtonComponent,
                    SpinnerComponent,
...
exports.ControlMessagesComponent = ControlMessagesComponent$$1;
exports.IconComponent = IconComponent;
exports.FF_INPUT_CONTROL_VALUE_ACCESSOR = FF_INPUT_CONTROL_VALUE_ACCESSOR;
exports.InputComponent = InputComponent;
exports.FFMaterialModule = FFMaterialModule;
